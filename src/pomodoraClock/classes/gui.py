...
class PomodoraClock:
    ...
    def __init__(self, root):
        ...
        pygame.init()
        self.sound = pygame.mixer.Sound(get_path("assets/sounds/switch-noise.wav"))
...
##############  PAGES ##############
    def home_page(self):
        ...
        home_page_image = tkb.PhotoImage(file=get_path("assets/images/actual/HOME.png"))
    ...
    def config_page(self):
        config_page_image = tkb.PhotoImage(file=get_path('assets/images/actual/CONFIG.png'))
        self._show_spinbox()
        self._show_labels()
    ...
    def start_page(self):
        ...
        start_page_image = tkb.PhotoImage(file=get_path('assets/images/actual/STUDYING.png'))
    ...
    def pause_page(self):
        pause_page_image = tkb.PhotoImage(file=get_path('assets/images/actual/PAUSED.png'))
    ...
    def resting_page(self):
        ...
        resting_page_image = tkb.PhotoImage(file=get_path('assets/images/actual/RESTING.png'))
